...
function change_model(modelhash, seconds)
	...
	globals.set_int(2639889 + 48, modelhash)
	globals.set_int(2639889 + 48, modelhash)
	globals.set_int(2639889 + 48, modelhash)
	globals.set_int(2639889 + 61, 1)
	globals.set_int(2639889 + 48, modelhash)
	globals.set_int(2639889 + 48, modelhash)
	globals.set_int(2639889 + 48, modelhash)
	sleep(0.1)
	...
	while changed ~= true do
		curvalue = globals.get_int(2639889 + 48)
		if curvalue ~= modelhash then
			times = times + 1
			if globals.get_int(2639889 + 61) ~= 1 then
				globals.set_int(2639889 + 61, 1)
			end
			for i=1,times do
				globals.set_int(2639889 + 48, modelhash)
	...
	globals.set_int(2639889 + 61, 0)
	print(globals.get_int(2639889 + 48))
end
